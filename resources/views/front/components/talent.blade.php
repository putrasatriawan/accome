<div class="col-lg-6 d-flex justify-content-center align-items-start">
    <div class="card position-relative shadow"
        ...
        <div class="position-absolute z-index--1 me-10 me-xxl-0"
             style="right:-160px;top:-210px;"> <img src="assets/img/steps/bg.png"
                 style="max-width:550px;"
                 alt="shape" /></div>
        <div class="card-body p-3">
            <img class="mb-4 mt-2 rounded-2 w-100"
                 src="{{ asset('front/assets_front_home/img/steps/booking-img.jpg') }}"
                 alt="booking" />
            <div>
                ...
                <div class="icon-group mb-4"> <span class="btn icon-item"> <img
                             src="{{ asset('front/assets_front_home/img/steps/leaf.svg') }}"
                             alt="" /></span><span class="btn icon-item"> <img
                             src="{{ asset('front/assets_front_home/img/steps/map.svg') }}"
                             alt="" /></span><span class="btn icon-item"> <img
                             src="{{ asset('front/assets_front_home/img/steps/send.svg') }}"
                             alt="" /></span>
                </div>
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center mt-n1"><img class="me-3"
                             src="{{ asset('front/assets_front_home/img/steps/building.svg') }}"
                             width="18"
